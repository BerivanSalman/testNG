...
public class CO6_HardAssertion {
    @Test
    public void hardAssertionTesti(){
        //assert yazdıgımızda herhangi bir assertte hata oldugunda diger assertlere bakmaz
        // hemen ilk hata oldugunda assertion fırlatır
