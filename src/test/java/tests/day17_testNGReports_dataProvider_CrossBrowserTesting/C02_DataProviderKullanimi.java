...
public class C02_DataProviderKullanimi extends TestBaseRapor {
    ...
    public static Object[][] aranacakUrunlerDataProvider() {
        ...
        // bir method'dur
        String[][] aranacakUrunler ={{"phone"},{"java"},{"dress"},{"nutella"},{"chair"},{"tea"}};
        // 27. satırdaki arrayı kopyalayıp iki katlı array olması icin  duzenleme yaparak buraya yapıstırırız

        return aranacakUrunler;
    }

    @Test(dataProvider = "aranacakUrunlerDataProvider") //arananUrun data provider dan gelsin isteriz. Once Data provider does not exist der
    // u yüzden 61. satırın ustune gelip creat e basarız
