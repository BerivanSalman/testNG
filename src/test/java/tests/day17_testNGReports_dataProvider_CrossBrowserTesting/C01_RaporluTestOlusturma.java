...
public class C01_RaporluTestOlusturma extends TestBaseRapor {
    //Bu classı calıstırdıktan sonra test-output ın icinde rapor olusur ve sag click yapıp Open In e basarız. Browser a basıp chrome yi seceriz
    //Eger test failed olursa Screenshot ı alır ve screenshot diye dosya olusturur
