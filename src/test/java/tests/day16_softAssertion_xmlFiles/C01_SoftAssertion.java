...
public class C01_SoftAssertion {
    ...
    public void softAssertionTesti(){
        // Softassertle assertAll yapıp kapatırsak herhangi bir yerde sorun olsa da teste devam eder.
        //assertAll yapip kapattıgımız icin bize raporlama doner ama nerde hata oldugunu tam anlayamayız
        //O yüzden , koyup mesajı yazmamız gerek her soft assert yaptıgımız yere
