...
public class C02_SoftAssertion {
    ...
    public void softAssertionTesti(){
       ...
       ZeroWebappsecurityPage zeroPage = new ZeroWebappsecurityPage();
        zeroPage.signInButton.click();

        // 4. Login kutusuna “username” yazin
        zeroPage.signInUsername.sendKeys("username");
        // 5. Password kutusuna “password” yazin
        zeroPage.signInpassword.sendKeys("password");
        // 6. Sign in tusuna basin
        zeroPage.signInButton.click();
        // 7. Back tusuna basin
        Driver.getDriver().navigate().back();
        // 8. Giris yapilabildigi dogrulayin
        softAssert.assertTrue(zeroPage.onlineBanking.isDisplayed(),"Giris yapilamadi");
        ...
        zeroPage.foreignPurchaseButton.click();
